...
makeCacheMatrix <- function(x = matrix()) {
  ...
  loadinverse<-function()inverse##sets up a function that provides the 
  ##current value of the inverse. Mainly used 
  ##to check to see if there is a value cached.
  reset<- function(z) {##Lets you change the matrix values in the special 
    ##"matrix" created by makeCacheMatrix. Not required but 
    ##it was in the example and useful for testing the program.
